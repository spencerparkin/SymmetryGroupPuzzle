...
class Puzzle17(Puzzle):
    def __init__(self):
        ...
        sub_region.polygon.vertex_list.append(Vector(0.0, -2.0))
        ...
        sub_region.polygon.vertex_list.append(Vector(-2.0, -1.0))
        hole = Polygon()
        hole.polygon.vertex_list.append(Vector(0.0, 0.0))
        hole.polygon.vertex_list.append(Vector(0.0, 1.0))
        hole.polygon.vertex_list.append(Vector(-1.0, 1.0))
        hole.polygon.vertex_list.append(Vector(-1.0, 0.0))
